/* Brand glyphs that lucide-react doesn't ship (WhatsApp + socials). */
...
/* Hand-drawn spiral arrow used with Caveat annotations. */
export function SpiralArrow({ className = "", flip = false }: { className?: string; flip?: boolean }) {
  return (
    <svg
      viewBox="0 0 64 90"
      fill="none"
      ...
      aria-hidden="true"
    >
      <path d="M40 6C22 16 10 34 12 54c1 9 6 16 14 20" />
      <path d="M30 66l-4.6 9.4L15 72" />
    </svg>
  );
}
